...
To produce a pdf file with a qq plot showing BTG1, clone this repository, ensure the required packaged are installed, and run `R CMD BATCH makeQQplot.R`.  To execute code interactively, use the qqPLot.qmd in RStudio.
